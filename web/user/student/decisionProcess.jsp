...
<script type="text/javascript" src="<c:url value='/js/jQuery/plugins/jquery-ui/ui/minified/jquery.ui.tabs.min.js' />" ></script>
...
<s:if test="#attr.user.type.toString() != 'STUDENT'">
		<p>您身份不合法，请勿试图破坏系统</p>
</s:if>
<s:elseif test="#attr.user.joinedCampaigns.size() == 0">
		<p>你尚未加入任何课程</p>
</s:elseif>
<s:else>
...
<div id="left-panel">
<%@ include file="/fragment/player/decision_menu.inc" %>
</div>
</td>
<td class="align-top">
<div id="right-panel">
<%@ include file="/fragment/player/decision.inc" %>
</div>
</td>
</tr>
</table>
